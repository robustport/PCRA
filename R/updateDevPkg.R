...
# 
getVersionGithub = function(repo, field, type) {
...
update_dev_pkg = function(pkg="PCRA", repo="https://github.com/robustport/PCRA",lib=NULL, ...) {
  ...
  una = is.na(ups<-getVersionGithub(repo, field, type))
  if (una)
